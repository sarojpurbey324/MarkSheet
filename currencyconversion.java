              ...
              if(n==1)
               ...
               else if(n==7)
                  {
                   ...
                   sourcep="NZD New Zealand Dollars ";
					...
					out.println("<TR><TD colspan=2 align=center><BR><BR><button onclick='location=\""+relpath+"/index.jsp\"' accesskey='C'><u>C</U>ontinue</button>&nbsp;&nbsp;&nbsp;<button onclick='location=\""+relpath+"/Pages/Signout.jsp\"' accesskey='S'><u>S</U>ignout</button><button onclick=\"window.print()\" accesskey='S'><u>P</U>rint</button></TD></TR>");
